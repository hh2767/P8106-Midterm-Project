...
data_split = data %>% 
    select(-club)
train = data_split[trRows,] %>% write_csv("./exploratory analysis/train.csv")
test = data_split[-trRows,] %>% write_csv("./exploratory analysis/test.csv")
```
...
cor_data = data %>% 
    select(-club, -nationality, -na_count)
